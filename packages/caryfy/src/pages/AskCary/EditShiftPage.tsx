...
import EditShift from "../../components/AskCary/EditShift";
...
const EditShiftPage: FunctionComponent = () => {
    ...
    return (
        <div className="w-full relative bg-surface-bg-primary overflow-hidden flex flex-col items-start justify-start min-w-[360px] max-w-[1920px] leading-[normal] tracking-[normal] text-left text-xl text-colors-text-black font-body-xs-semi-bold">
            <Header />
            <div className="self-stretch bg-gray overflow-hidden flex flex-col items-center justify-start relative gap-[24px] min-h-[890px] max-w-full"  style={{ paddingTop: "80px" }}>
                <img
